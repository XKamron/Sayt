export const qonunKorrupsiya = [
    {
      title: '1-bob. Umumiy qoidalar',
      content: (
        <div className="">
            <h1 className="text-center text-2xl font-bold" >1-bob. Umumiy qoidalar</h1>
            <div>
            <p className="font-semibold">1-modda. Ushbu Qonunning maqsadi</p>
          <p className="py-4">Ushbu Qonunning maqsadi mehnatni muhofaza qilish sohasidagi munosabatlarni tartibga solishdan iborat.</p>
            </div>
            <div>
            <p className="font-semibold">2-modda. Korrupsiyaga qarshi kurashish to‘g‘risidagi qonunchilik</p>
          <p className="py-4">Korrupsiyaga qarshi kurashish to‘g‘risidagi qonunchilik ushbu Qonun va boshqa qonunchilik hujjatlaridan iboratdir.
...
Agar O‘zbekiston Respublikasining xalqaro shartnomasida korrupsiyaga qarshi kurashish to‘g‘risidagi qonunchilikda nazarda tutilganidan boshqacha qoidalar belgilangan bo‘lsa, xalqaro shartnoma qoidalari qo‘llaniladi.</p>
            ...
            <div>
            <p className="font-semibold">3-modda. Asosiy tushunchalar</p>
          <p className="py-4">Ushbu Qonunda quyidagi asosiy tushunchalar qo‘llaniladi:
<br/>
...
manfaatlar to‘qnashuvi — shaxsiy (bevosita yoki bilvosita) manfaatdorlik shaxsning mansab yoki xizmat majburiyatlarini lozim darajada bajarishiga ta’sir ko‘rsatayotgan yoxud ta’sir ko‘rsatishi mumkin bo‘lgan hamda shaxsiy manfaatdorlik bilan fuqarolarning, tashkilotlarning, jamiyatning yoki davlatning huquqlari va qonuniy manfaatlari o‘rtasida qarama-qarshilik yuzaga kelayotgan yoki yuzaga kelishi mumkin bo‘lgan vaziyat.</p>
            ...
            <div>
            <p className="font-semibold">4-modda. Korrupsiyaga qarshi kurashishning asosiy prinsiplari</p>
          <p className="py-4">Korrupsiyaga qarshi kurashishning asosiy prinsiplari quyidagilardan iborat:
...
javobgarlikning muqarrarligi.</p>
            ...
            <div>
            <p className="font-semibold">5-modda. Korrupsiyaga qarshi kurashish sohasidagi davlat siyosatining asosiy yo‘nalishlari</p>
          <p className="py-4">Korrupsiyaga qarshi kurashish sohasidagi davlat siyosatining asosiy yo‘nalishlari quyidagilardan iborat:
...
korrupsiyaga oid huquqbuzarliklarni o‘z vaqtida aniqlash, ularga chek qo‘yish, ularning oqibatlarini, ularga imkon beruvchi sabablar va shart-sharoitlarni bartaraf etish, korrupsiyaga oid huquqbuzarliklarni sodir etganlik uchun javobgarlikning muqarrarligi prinsipini ta’minlash.</p>
            ...
            <div>
            <p className="font-semibold">6-modda. Korrupsiyaga qarshi kurashish sohasidagi davlat dasturlari va boshqa dasturlar</p>
          <p className="py-4">Korrupsiyaga qarshi kurashish sohasidagi davlat siyosati davlat dasturlari va boshqa dasturlar asosida amalga oshirilishi mumkin.
...
Davlat dasturlari va boshqa dasturlar ushbu Qonunning qoidalari samarali ijro etilishini ta’minlash, korrupsiyaning holati hamda tendensiyalaridan kelib chiqqan holda korrupsiyaga qarshi kurashish bo‘yicha kompleks va tizimli chora-tadbirlar ko‘rish maqsadida ishlab chiqiladi hamda amalga oshiriladi.</p>
    ...
    },
    {
        ...
        content: (
          <div className="">
              <h1 className="text-center text-2xl font-bold" >2-bob. Korrupsiyaga qarshi kurashish bo‘yicha faoliyatni amalga oshiruvchi va unda ishtirok etuvchi organlar hamda tashkilotlar</h1>
              <div>
              <p className="font-semibold">7-modda. Korrupsiyaga qarshi kurashish bo‘yicha faoliyatni amalga oshiruvchi davlat organlari</p>
            <p className="py-4">Korrupsiyaga qarshi kurashish bo‘yicha faoliyatni bevosita amalga oshiruvchi davlat organlari quyidagilardan iborat:
...
O‘zbekiston Respublikasi Korrupsiyaga qarshi kurashish agentligi Milliy kengashning ishchi organidir.</p>
              ...
              <div>
              <p className="font-semibold">8-1-modda. O‘zbekiston Respublikasi Korrupsiyaga qarshi kurashish agentligining korrupsiyaga qarshi kurashish sohasidagi vakolatlari</p>
            <p className="py-4">O‘zbekiston Respublikasi Korrupsiyaga qarshi kurashish agentligi o‘z vakolatlari doirasida:
...
O‘zbekiston Respublikasi Korrupsiyaga qarshi kurashish agentligi qonunchilikka muvofiq boshqa vakolatlarni ham amalga oshirishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">9-modda. O‘zbekiston Respublikasi Bosh prokuraturasining korrupsiyaga qarshi kurashish sohasidagi vakolatlari</p>
            <p className="py-4">O‘zbekiston Respublikasi Bosh prokuraturasi o‘z vakolatlari doirasida:
...
O‘zbekiston Respublikasi Bosh prokuraturasi qonunchilikka muvofiq boshqa vakolatlarni ham amalga oshirishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">10-modda. O‘zbekiston Respublikasi Davlat xavfsizlik xizmatining korrupsiyaga qarshi kurashish sohasidagi vakolatlari</p>
            <p className="py-4">O‘zbekiston Respublikasi Davlat xavfsizlik xizmati o‘z vakolatlari doirasida:
...
O‘zbekiston Respublikasi Davlat xavfsizlik xizmati qonunchilikka muvofiq boshqa vakolatlarni ham amalga oshirishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">11-modda. O‘zbekiston Respublikasi Ichki ishlar vazirligining korrupsiyaga qarshi kurashish sohasidagi vakolatlari</p>
            <p className="py-4">O‘zbekiston Respublikasi Ichki ishlar vazirligi o‘z vakolatlari doirasida:
...
O‘zbekiston Respublikasi Ichki ishlar vazirligi qonunchilikka muvofiq boshqa vakolatlarni ham amalga oshirishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">12-modda. O‘zbekiston Respublikasi Adliya vazirligining korrupsiyaga qarshi kurashish sohasidagi vakolatlari</p>
            <p className="py-4">O‘zbekiston Respublikasi Adliya vazirligi o‘z vakolatlari doirasida:
...
O‘zbekiston Respublikasi Adliya vazirligi qonunchilikka muvofiq boshqa vakolatlarni ham amalga oshirishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">13-modda. O‘zbekiston Respublikasi Bosh prokuraturasi huzuridagi Iqtisodiy jinoyatlarga qarshi kurashish departamentining korrupsiyaga qarshi kurashish sohasidagi vakolatlari</p>
            <p className="py-4">O‘zbekiston Respublikasi Bosh prokuraturasi huzuridagi Iqtisodiy jinoyatlarga qarshi kurashish departamenti o‘z vakolatlari doirasida:
...
O‘zbekiston Respublikasi Bosh prokuraturasi huzuridagi Iqtisodiy jinoyatlarga qarshi kurashish departamenti qonunchilikka muvofiq boshqa vakolatlarni ham amalga oshirishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">14-modda. Fuqarolar o‘zini o‘zi boshqarish organlarining, nodavlat notijorat tashkilotlarining va fuqarolarning korrupsiyaga qarshi kurashishda ishtirok etishi</p>
            <p className="py-4">Fuqarolarning o‘zini o‘zi boshqarish organlari, nodavlat notijorat tashkilotlari va fuqarolar:
...
Nodavlat notijorat tashkilotlari ushbu moddada nazarda tutilgan tadbirlarni amalga oshirish maqsadida Milliy kengash va hududiy kengashlar faoliyatida, shuningdek davlat organlari huzuridagi ishchi guruhlar, komissiyalar va jamoat-maslahat organlari faoliyatida qonunchilikda belgilangan tartibda ishtirok etadi.</p>
              ...
              <div>
              <p className="font-semibold">15-modda. Ommaviy axborot vositalarining korrupsiyaga qarshi kurashishda ishtirok etishi

</p>
            <p className="py-4">Ommaviy axborot vositalari:
...
Ommaviy axborot vositalari qonunchilikka muvofiq boshqa tadbirlarda ham ishtirok etishi mumkin.</p>
      ...
      },
      {
        ...
        content: (
          <div className="">
              <h1 className="text-center text-2xl font-bold" >3-bob. Korrupsiyaga qarshi kurashish sohasida huquqiy ong va huquqiy madaniyatni yuksaltirish</h1>
              <div>
              <p className="font-semibold">16-modda. Aholining huquqiy ongi va huquqiy madaniyatini yuksaltirish, jamiyatda korrupsiyaga nisbatan murosasiz munosabatni shakllantirish</p>
            <p className="py-4">Davlat organlari va boshqa tashkilotlar korrupsiyaga qarshi kurashish maqsadida aholining huquqiy ongi va huquqiy madaniyatini yuksaltirish, jamiyatda korrupsiyaga nisbatan murosasiz munosabatni shakllantirish bo‘yicha zarur chora-tadbirlar ko‘radi, shu jumladan korrupsiyaga qarshi kurashish masalalariga doir tushuntirish ishlarini amalga oshirish, huquqiy tarbiya va ta’limni, ilmiy-amaliy tadbirlarni tashkil etish, o‘quv-uslubiy va ilmiy adabiyotlarni ishlab chiqish yo‘li bilan zarur chora-tadbirlar ko‘radi.</p>
              </div>
              <div>
              <p className="font-semibold">17-modda. Davlat organlari va boshqa tashkilotlar xodimlarining huquqiy savodxonligini oshirish</p>
            <p className="py-4">Davlat organlari va boshqa tashkilotlar o‘z mansabdor shaxslarining hamda boshqa xodimlarining korrupsiyaga qarshi kurashish sohasidagi huquqiy savodxonligini, shu jumladan huquqiy bilimlari darajasini oshirish yuzasidan zarur chora-tadbirlar ko‘radi.</p>
              </div>
              <div>
              <p className="font-semibold">18-modda. Ta’lim muassasalarida korrupsiyaga qarshi kurashish sohasidagi huquqiy ta’lim va tarbiya</p>
            <p className="py-4">Ta’lim muassasalarida korrupsiyaga qarshi kurashish sohasidagi huquqiy ta’lim va tarbiya belgilangan davlat ta’lim standartlariga muvofiq amalga oshiriladi.
...
Davlat ta’limni boshqarish organlari va ta’lim muassasalari korrupsiyaga qarshi kurashish sohasidagi davlat siyosatining asosiy yo‘nalishlarini inobatga olgan holda ta’lim muassasalarida huquqiy ta’lim va tarbiyaga, mutaxassislarni kasbiy tayyorlashning sifatini oshirishga, ta’lim dasturlarini doimiy ravishda takomillashtirib borishga qaratilgan chora-tadbirlarni ishlab chiqadi.</p>
      ...
      },
      {
        ...
        content: (
          <div className="">
              <h1 className="text-center text-2xl font-bold" >4-bob. Korrupsiyaning oldini olishga doir chora-tadbirlar</h1>
              <div>
              <p className="font-semibold">19-modda. Davlat boshqaruvi sohasida korrupsiyaning oldini olishga doir chora-tadbirlar</p>
            <p className="py-4">Davlat boshqaruvi sohasida korrupsiyaning oldini olishga doir chora-tadbirlar quyidagilardan iborat:
...
Davlat organlarining va o‘zga tashkilotlarning mansabdor shaxslari hamda boshqa xodimlari qonunchilikka rioya etishi, o‘z mansab yoki xizmat majburiyatlarini beg‘arazlik bilan, xolisona, vijdonan, odob-axloq qoidalariga rioya etgan holda bajarishi hamda korrupsiyaga oid biror-bir huquqbuzarlikni sodir etishdan yoki bunday huquqbuzarliklarni sodir etish uchun shart-sharoitlar yaratadigan boshqa har qanday harakatlardan o‘zini tiyishi shart.</p>
              ...
              <div>
              <p className="font-semibold">20-modda. Ijtimoiy-iqtisodiy rivojlanish va tadbirkorlik sohasida korrupsiyaning oldini olishga doir chora-tadbirlar</p>
            <p className="py-4">Ijtimoiy-iqtisodiy rivojlanish va tadbirkorlik sohasida korrupsiyaning oldini olishga doir chora-tadbirlar quyidagilardan iborat:
...
Qonunchilikda ijtimoiy-iqtisodiy rivojlanish va tadbirkorlik sohasida korrupsiyaning oldini olishga doir boshqa chora-tadbirlar ham nazarda tutilishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">21-modda. Manfaatlar to‘qnashuvining oldini olish va uni bartaraf etishga doir chora-tadbirlar</p>
            <p className="py-4">Davlat organlarining xodimlari mansab yoki xizmat majburiyatlarini bajarish chog‘ida manfaatlar to‘qnashuviga olib keladigan yoki olib kelishi mumkin bo‘lgan shaxsiy manfaatdorlikka yo‘l qo‘ymasligi kerak.
...
Davlat organlarining manfaatlar to‘qnashuvining oldini olish yoki uni bartaraf etish talablari buzilishiga yo‘l qo‘ygan xodimlari, shuningdek ularning rahbarlari qonunchilikka muvofiq javobgar bo‘ladi.</p>
              ...
              <div>
              <p className="font-semibold">22-modda. Ma’muriy tartib-taomillar sohasida korrupsiyaning oldini olishga doir chora-tadbirlar</p>
            <p className="py-4">Ma’muriy tartib-taomillar sohasida korrupsiyaning oldini olishga doir chora-tadbirlar quyidagilardan iborat:
...
Qonunchilikda ma’muriy tartib-taomillar sohasida korrupsiyaning oldini olishga doir boshqa chora-tadbirlar ham nazarda tutilishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">23-modda. Davlat xaridlarini amalga oshirish sohasida korrupsiyaning oldini olishga doir chora-tadbirlar</p>
            <p className="py-4">Davlat xaridlarini amalga oshirish sohasida korrupsiyaning oldini olishga doir chora-tadbirlar quyidagilardan iborat:
...
Qonunchilikda davlat xaridlarini amalga oshirish sohasida korrupsiyaning oldini olishga doir boshqa chora-tadbirlar ham nazarda tutilishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">24-modda. Normativ-huquqiy hujjatlarning va ular loyihalarining korrupsiyaga qarshi ekspertizasi</p>
            <p className="py-4">Normativ-huquqiy hujjatlarning va ular loyihalarining korrupsiyaga qarshi ekspertizasi:
...
Normativ-huquqiy hujjatlarning va ular loyihalarining korrupsiyaga qarshi ekspertizasi “Normativ-huquqiy hujjatlarning va ular loyihalarining korrupsiyaga qarshi ekspertizasi to‘g‘risida”gi O‘zbekiston Respublikasi Qonunida belgilangan tartibda o‘tkaziladi.</p>
      ...
      },
      {
        ...
        content: (
          <div className="">
              <h1 className="text-center text-2xl font-bold" >5-bob. Korrupsiyaga oid huquqbuzarliklarni aniqlash, ularga chek qo‘yish, javobgarlikning muqarrarligi</h1>
              <div>
              <p className="font-semibold">25-modda. Korrupsiyaga oid huquqbuzarliklarni o‘z vaqtida aniqlash va ularga chek qo‘yishga, korrupsiyaga oid huquqbuzarliklarni sodir etganlik uchun javobgarlikning muqarrarligi prinsipini ta’minlashga doir chora-tadbirlar</p>
            <p className="py-4">Korrupsiyaga oid huquqbuzarliklarni o‘z vaqtida aniqlash va ularga chek qo‘yishga, korrupsiyaga oid huquqbuzarliklarni sodir etganlik uchun javobgarlikning muqarrarligi prinsipini ta’minlashga doir chora-tadbirlar quyidagilardan iborat:
...
korrupsiyaga qarshi kurashning samarali jinoyat-huquqiy va jinoyat-protsessual mexanizmlarini yaratish.</p>
              ...
              <div>
              <p className="font-semibold">26-modda. Davlat organlari xodimlarining korrupsiyaga oid huquqbuzarliklar faktlari to‘g‘risida xabar qilish majburiyati</p>
            <p className="py-4">Davlat organlarining xodimlari ularni korrupsiyaga oid huquqbuzarliklar sodir etishga ko‘ndirish maqsadida biror-bir shaxs o‘zlariga murojaat etganligiga doir barcha hollar to‘g‘risida, shuningdek davlat organlarining boshqa xodimlari tomonidan sodir etilgan shunga o‘xshash huquqbuzarliklarning o‘zlariga ma’lum bo‘lib qolgan har qanday faktlari haqida o‘z rahbarini yoxud huquqni muhofaza qiluvchi organlarni xabardor etishi shart.
...
Ushbu moddaning birinchi qismida nazarda tutilgan majburiyatning davlat organlarining xodimlari tomonidan bajarilmaganligi qonunchilikka muvofiq javobgarlikka sabab bo‘ladi.</p>
              ...
              <div>
              <p className="font-semibold">27-modda. Korrupsiyaga oid huquqbuzarliklar uchun javobgarlik</p>
            <p className="py-4">Korrupsiyaga oid huquqbuzarliklar sodir etganlik qonunchilikka muvofiq javobgarlikka sabab bo‘ladi.
...
Yuridik shaxslar korrupsiyaga oid huquqbuzarliklarni sodir etganlik uchun qonunda belgilangan tartibda javobgar bo‘ladi.</p>
              ...
              <div>
              <p className="font-semibold">28-modda. Korrupsiyaga oid huquqbuzarliklar to‘g‘risidagi axborotni xabar qiluvchi shaxslarni va ularning yaqin qarindoshlarini himoya qilish</p>
            <p className="py-4">Korrupsiyaga oid huquqbuzarliklar to‘g‘risidagi axborotni xabar qiluvchi shaxslar va ularning yaqin qarindoshlari davlat himoyasida bo‘ladi.
...
Ushbu moddaning qoidalari korrupsiyaga oid huquqbuzarliklar to‘g‘risida bila turib yolg‘on axborotni xabar qilgan shaxslarga nisbatan tatbiq etilmaydi, ular bunday huquqbuzarlik uchun qonunga muvofiq javobgar bo‘ladi.</p>
              ...
              <div>
              <p className="font-semibold">29-modda. Korrupsiyaga oid huquqbuzarliklar natijasida qabul qilingan qarorlarni bekor qilish yoki o‘zgartirish</p>
            <p className="py-4">Korrupsiyaga oid huquqbuzarliklar natijasida qabul qilingan qarorlar manfaatdor shaxsning arizasiga ko‘ra vakolatli davlat organi, boshqa tashkilot yoki mansabdor shaxs tomonidan bekor qilinishi yoxud o‘zgartirilishi yoki sud tartibida haqiqiy emas deb topilishi mumkin.
...
Korrupsiyaga oid huquqbuzarliklar sodir etilganligi natijasida qabul qilingan qaror bekor qilingan, o‘zgartirilgan yoki haqiqiy emas deb topilgan taqdirda, uning qabul qilinishi natijasida jismoniy va yuridik shaxslarga yetkazilgan zararning o‘rni qonunchilikda belgilangan tartibda qoplanishi lozim.</p>
      ...
      },
      {
        ...
        content: (
          <div className="">
              <h1 className="text-center text-2xl font-bold" >6-bob. Yakunlovchi qoidalar</h1>
              <div>
            <p className="py-4">Korrupsiyaning holatini, xususiyatini, miqyoslarini, o‘zgarishlarini va tendensiyalarini, shuningdek korrupsiyaga qarshi kurashish sohasidagi davlat siyosatining amalga oshirilish samaradorligini o‘rganish davlat organlari tomonidan fuqarolarning o‘zini o‘zi boshqarish organlari, nodavlat notijorat tashkilotlari va boshqa tashkilotlar, ommaviy axborot vositalari, shuningdek fuqarolar bilan hamkorlikda sotsiologik, maxsus, ilmiy tadqiqotlar hamda boshqa turdagi tadqiqotlar o‘tkazish yo‘li bilan doimiy asosda amalga oshiriladi.
...
Davlat korrupsiyaga qarshi kurashish sohasidagi tadqiqotlarni qo‘llab-quvvatlaydi va rag‘batlantiradi.</p>
              ...
              <div>
              <p className="font-semibold">31-modda. Axborot olish</p>
            <p className="py-4">Har kim davlat organlarining tashkil etilishi va faoliyat ko‘rsatishi to‘g‘risida, shu shaxsning o‘ziga yoki shaxslar guruhiga taalluqli bo‘lgan hujjatlarning qabul qilinish jarayonlari haqida axborot olish huquqiga ega.
...
Axborot olish faqat qonunga muvofiq cheklanishi mumkin.</p>
              ...
              <div>
              <p className="font-semibold">32-modda. Korrupsiyaga qarshi kurashish sohasida xalqaro hamkorlik</p>
            <p className="py-4">Korrupsiyaga qarshi kurashish sohasida xalqaro hamkorlik O‘zbekiston Respublikasining qonunchiligi va xalqaro shartnomalariga muvofiq amalga oshiriladi.
...
Korrupsiyaga qarshi kurashish bo‘yicha faoliyatni amalga oshiruvchi davlat organlari korrupsiyaga oid huquqbuzarliklar natijasida olingan mol-mulkni O‘zbekiston Respublikasining qonunchiligi va xalqaro shartnomalariga muvofiq qaytarish choralarini ko‘radi.</p>
              </div>
              <div>
              <p className="font-semibold">33-modda. Qonunchilikni ushbu Qonunga muvofiqlashtirish</p>
            <p className="py-4">O‘zbekiston Respublikasi Vazirlar Mahkamasi:

hukumat qarorlarini ushbu Qonunga muvofiqlashtirsin;

davlat boshqaruvi organlari ushbu Qonunga zid bo‘lgan o‘z normativ-huquqiy hujjatlarini ko‘rib chiqishlari va bekor qilishlarini ta’minlasin.</p>
              </div>
              <div>
              <p className="font-semibold">34-modda. Ushbu Qonunning kuchga kirishi</p>
            <p className="py-4">Ushbu Qonun rasmiy e’lon qilingan kundan e’tiboran kuchga kiradi.</p>
            <div className="flex justify-between items-center font-semibold">
                <p className="text-center">Toshkent sh., <br/>
2017-yil 3-yanvar,<br/>
O‘RQ-419-son</p>
