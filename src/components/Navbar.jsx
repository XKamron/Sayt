...
const Navbar = () => {
  ...
  const navLinks = [
    {
      ...
      children: [
        ...
        { to: '/maktabKorsatkichlari', text: 'Maktab ko`rsatkichlari' },
        { to: '/savolJavob', text: 'Savol bering - javob beramiz' },
      ],
    },
    {
      ...
      children: [
        ...
        { to: '/prezidentFarmonlari', text: 'O‘zbekiston Respublikasi Prezidentining farmonlari va qarorlari' },
        { to: '/vazirBuyruqlari', text: 'O‘zbekiston Respublikasi Madaniyat vazirining buyruqlari' },
        { to: '/adliyaHujjatlar', text: 'O‘zbekiston Respublikasi Adliya vazirligidan ro‘yxatdan o‘tgan hujjatlar' },
      ],
    },
    {
    ...
    children: [
      ...
      { to: '/lokalHujjatlar', text: 'Lokal hujjatlar' },
      { to: '/bmsmXodimlari', text: 'BMSM xodimlarining odob-axloq qoidalari' },
      { to: '/malakaTavsiflari', text: 'Malaka tavsiflari' },
      { to: '/oquvchilarXavfsizligi', text: 'Oquvchilar xavfsizligi' },
      { to: '/mehnatMuxofazasi', text: 'Mehnat muhofazasi' },
  ...
  },
  {
    ...
    children: [
      { to: '/oquvjarayonlariHujjatlar', text: 'Hujjatlar' },
      { to: '/oquvDasturlari', text: 'O`quv dasturlari' },
      { to: '/tanlovlar', text: 'Tanlovlar, festivallar' },
      { to: '/bmsmPedagogikKengash', text: 'BMSM pedagogik kengashi' },
    ],
  },
  ];
