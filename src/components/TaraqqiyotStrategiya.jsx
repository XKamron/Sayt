                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <section className="mb-12 bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="bg-sky-800 text-white px-6 py-4">
                            <h2 className="text-xl font-bold">I. INSON QADRINI YUKSALTIRISH VA ERKIN FUQAROLIK JAMIYATINI YANADA RIVOJLANTIRISH ORQALI XALQPARVAR DAVLAT BARPO ETISH</h2>
                        </div>
                        <div className="p-6">
                    ...
                    <section className="mb-12 bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="bg-sky-800 text-white px-6 py-4">
                            <h2 className="text-xl font-bold">II. MAMLAKATIMIZDA ADOLAT VA QONUN USTUVORLIGI TAMOYILLARINI TARAQQIYOTNING ENG ASOSIY VA ZARUR SHARTIGA AYLANTIRISH</h2>
                        </div>
                        <div className="p-6">
                            <p className="text-gray-700 leading-relaxed">
                                Ikkinchi yo'nalish adolat va qonun ustuvorligini mustahkamlash, inson qadr-qimmatini ta'minlash vazifalarini qamrab olgan. Shu maqsadda sudlov tizimi va advokatura instituti, huquq-tartibot organlari faoliyati takomillashtiriladi. Tadbirkor va mulkdorlar huquqlarining himoyasi kuchaytiriladi. Korrupsiyaga barham berishga davlat va jamiyatning barcha kuch va vositalari safarbar etiladi. Bunda aybdorlarni huquqiy javobgarlikka tortish bilan cheklanib qolmasdan, korrupsiyaning sabablarini oldindan bartaraf etish choralari ko'riladi.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className="mb-12 bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="bg-sky-800 text-white px-6 py-4">
                            <h2 className="text-xl font-bold">III. MILLIY IQTISODIYOTNI JADAL RIVOJLANTIRISH VA YUQORI O'SISH SUR'ATLARINI TA'MINLASH</h2>
                        </div>
                        <div className="p-6">
                            <p className="text-gray-700 leading-relaxed">
                    ...
                    <section className="mb-12 bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="bg-sky-800 text-white px-6 py-4">
                            <h2 className="text-xl font-bold">IV. ADOLATLI IJTIMOIY SIYOSAT YURITISH, INSON KAPITALINI RIVOJLANTIRISH</h2>
                        </div>
                        <div className="p-6">
                            <p className="text-gray-700 leading-relaxed">
                    ...
                    <section className="mb-12 bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="bg-sky-800 text-white px-6 py-4">
                            <h2 className="text-xl font-bold">V. MA'NAVIY TARAQQIYOTNI TA'MINLASH VA SOHANI YANGI BOSQICHGA OLIB CHIQISH</h2>
                        </div>
                        <div className="p-6">
                            <p className="text-gray-700 leading-relaxed">
                    ...
                    <section className="mb-12 bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="bg-sky-800 text-white px-6 py-4">
                            <h2 className="text-xl font-bold">VII. MAMLAKATIMIZ XAVFSIZLIGI VA MUDOFAA SALOHIYATINI KUCHAYTIRISH, OCHIQ, PRAGMATIK VA FAOL TASHQI SIYOSAT OLIB BORISH</h2>
                        </div>
                        <div className="p-6">
                            <p className="text-gray-700 leading-relaxed">
...
export default TaraqqiyotStrategiya;
