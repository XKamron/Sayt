  ...
  const tabs = [
    {
      ...
      content: (
        <>
          <h2 className="text-2xl sm:text-3xl font-bold text-sky-700 mb-6 pb-3 border-b border-gray-200">I bo‘lim. Umumiy qoidalar</h2>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>1-modda. O‘zbekiston Respublikasida aholini ish bilan ta’minlash to‘g‘risidagi qonunlar</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Aholini ish bilan ta’minlashga oid munosabatlar mazkur Qonun, O‘zbekiston Respublikasining boshqa qonun hujjatlari bilan, Qoraqalpog‘iston Respublikasi hududida esa Qoraqalpog‘iston Respublikasi qonunlari bilan ham tartibga solib boriladi.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>2-modda. O‘zbekiston Respublikasi aholisini ish bilan ta’minlash</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>1. Ish bilan ta’minlash odamlarning O‘zbekiston Respublikasi Konstitutsiyasiga va qonunlariga zid kelmaydigan, o‘z shaxsiy va ijtimoiy ehtiyojlarini qondirish bilan bog‘liq bo‘lgan, ularga ish haqi (mehnat daromadi) keltiradigan faoliyatidir.
...
Boshqa davlatlarning respublika hududida vaqtincha turib, diplomatik vakolatxonalar faoliyatini ta’minlash bilan bog‘liq bo‘lmagan ishlarni bajaruvchi fuqarolari ham ish bilan ta’minlangan aholi jumlasiga kiradi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>3-modda. Ishsizlar</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>16 yoshdan boshlab to pensiyaga chiqish huquqini olishgacha bo‘lgan yoshdagi, ishga va ish haqi (mehnat daromadi)ga ega bo‘lmagan, haqiqatda ish qidirayotgan, mehnat qilishga, kasb-kor tayyorgarligi va qayta tayyorgarlikdan o‘tishga tayyor shaxs sifatida ish bilan ta’minlash davlat xizmatlarida ro‘yxatga olingan va shu xizmatlar maqbul keladigan ishni taklif qilmagan, lekin mehnatga layoqatli shaxslar ishsizlar deb hisoblanadilar.
...
ish uzrli sabablar bilan, jumladan mehnatkashning shaxsiy yoki oilaviy ahvoliga asoslangan holda rad etilgan bo‘lsa, bunday ish maqbul keladigan ish deb hisoblanishi mumkin emas.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>5-modda. Aholini ish bilan ta’minlash sohasidagi davlat siyosatining asosiy qoidalari</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Aholini ish bilan ta’minlash sohasidagi davlat siyosati quyidagi qoidalarga asoslanadi:
...
aholini ish bilan ta’minlash muammolarini hal qilishda respublika ichida va davlatlararo hamkorlik.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>6-modda. Mehnat qilish huquqiga davlat kafolatlari</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>1. Davlat aholining ish bilan to‘la va samarali ta’minlanishiga ko‘maklashishga, mehnat qilish huquqini ro‘yobga chiqarishi uchun shart-sharoitlar yaratib berishga mas’ul bo‘lib:
...
3. Bunday shaxslarni belgilangan kvotalardan ortiq ravishda ishga qabul qilgan korxonalarga O‘zbekiston Respublikasining qonunlari bilan, xalq deputatlari mahalliy Sovetlarining qarorlari bilan daromad solig‘i to‘lashda, respublika va mahalliy budjetlarga boshqa to‘lovlar bo‘yicha imtiyozlar beriladi. Bunday imtiyozlar Vazirlar Mahkamasi tomonidan belgilanadi.</p>
    ...
    },
    {
      ...
      content: (
        <>
          <h2 className="text-2xl sm:text-3xl font-bold text-sky-700 mb-6 pb-3 border-b border-gray-200">II Bo‘lim. O‘zbekiston Respublikasi aholisining ish bilan ta’minlanish huquqlari</h2>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>9-modda. Ishga joylashish huquqi</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Mehnatkashlar korxonalarga, muassasalarga, tashkilotlarga, yakka dehqonchilik (fermer) xo‘jaliklariga, boshqa ish beruvchilarga bevosita murojaat qilish yoki ish bilan ta’minlash davlat xizmatlarining bepul vositachiligi orqali ish joyini erkin tanlash huquqiga egadirlar.
...
Ishga joylashish chog‘ida shartnomalarni (kontraktlar, bitimlarni) tuzish tartibi va shartlari amaldagi qonunlar bilan tartibga solinadi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>10-modda. O‘z kasb-koriga doir maslahatlar olish, tayyorgarlik va qayta tayyorgarlik ko‘rish hamda axborotlar olish huquqi</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Ish qidirayotgan va ish bilan ta’minlash davlat xizmatiga murojaat qilgan shaxslar ishni, ish joyini va mehnat tartibini erkin tanlash maqsadida o‘z kasb-koriga doir bepul maslahatlar olishga, tayyorgarlik va qayta tayyorgarlik ko‘rishga hamda tegishli axborotlar olishga haqlidir.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>11-modda. Ishga joylashishning kontrakt tuzish shaklidan foydalanish huquqi</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>1. Ishga joylashayotgan shaxslar barcha turdagi korxonalar, muassasalar va tashkilotlar bilan mehnat shartnomalari tuzishdan tashqari kontraktlar tuzishga ham haqlidirlar. Kontraktda mehnat qilishning har qanday shartlari nazarda tutilishi mumkin. O‘zbekiston Respublikasining qonunlariga zid keluvchi shartlar bundan mustasno.
<br />
2. Kontrakt amal qiladigan butun muddat davomida boshqa joyga borib ishlagan taqdirda kontrakt bilan ishlayotgan shaxsning doimiy istiqomat joyidagi uy-joy maydoni bronlashtirib qo‘yiladi. U yangi ish joyida kontraktga binoan uy-joy maydoni olish huquqidan mahrum bo‘lmaydi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>12-modda. Chet ellarda o‘z kasbi bo‘yicha faoliyat bilan shug‘ullanish huquqi</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>O‘zbekiston Respublikasi fuqarolari vaqtincha chet elda bo‘lgan davrda o‘z kasblari bo‘yicha faoliyat bilan shug‘ullanish huquqiga egadir. Bunday fuqarolarning huquqlari va manfaatlarini himoya qilish tartibi O‘zbekiston Respublikasi qonunlari bilan belgilanadi.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>13-modda. Mehnat sohasida ijtimoiy madad olish huquqi</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Belgilangan tartibda ishsiz deb e’tirof etilgan shaxslar ishsizlik nafaqasi olish huquqiga egadirlar.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>14-modda. Ish bilan ta’minlash davlat xizmati xodimlarining xatti-harakatlari ustidan shikoyat qilish huquqi</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Ish bilan ta’minlash davlat xizmati xodimlarining xatti-harakatlari ustidan yuqori idoraga, shuningdek O‘zbekiston Respublikasi qonunlarida belgilab qo‘yilgan tartibda sudga shikoyat qilish mumkin.</p>
          </div>
        </>
      )
    },
    {
      ...
      content: (
        <>
          <h2 className="text-2xl sm:text-3xl font-bold text-sky-700 mb-6 pb-3 border-b border-gray-200">III bo‘lim. Aholini ish bilan ta’minlashni tartibga solish va tashkil etish</h2>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>15-modda. Ish bilan ta’minlashni tartibga solish</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>O‘zbekiston Respublikasi davlat boshqaruvi idoralari:
...
mehnat faoliyati bilan shug‘ullanuvchi aholini ijtimoiy-huquqiy muhofaza qilish chora-tadbirlarini ko‘radilar.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>16-modda. Ish bilan ta’minlashning respublika va mintaqa dasturlari</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Aholini ish bilan ta’minlashga ko‘maklashish, ishsizlikning oldini olish va ishsizlik oqibatlaridan ijtimoiy muhofaza qilish maqsadida respublika miqyosida va mahalliy darajada ish bilan ta’minlash dasturlari ishlab chiqiladi.
...
Aholini ish bilan ta’minlash dasturining mazmuni, uni ishlab chiqish va amalga oshirish tartibi O‘zbekiston Respublikasi Vazirlar Mahkamasi tomonidan belgilanadi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>17-modda. Rivojlantirishda ustunlik beriladigan hududlar</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>O‘zbekiston Respublikasi Vazirlar Mahkamasi viloyat hokimliklarining tavsiyasiga binoan har yili ishchi o‘rinlari respublika Hukumati tomonidan rag‘batlantiriladigan hududlarni belgilaydi.
...
Ustuvor rivojlantiriladigan hududlarda ishlab chiqarishlar, ularning shu’balari, qo‘shimcha va nostandart ishchi o‘rinlari vujudga keltirayotgan korxonalar, muassasalar va tashkilotlarga O‘zbekiston Respublikasi qonunlari bilan belgilanadigan tartib va shartlar asosida soliqlar bo‘yicha yengilliklar va boshqa imtiyozlar beriladi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>18-modda. Ish bilan ta’minlashga ko‘maklashuvchi muvofiqlashtirish qo‘mitalari</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Ish bilan ta’minlash siyosatini belgilash va amalga oshirish bo‘yicha kelishilgan qarorlarni ishlab chiqish maqsadida respublika miqyosida va mahalliy darajalarda kasaba uyushmalarining, ish beruvchilar uyushmalari va davlat boshqaruvi idoralarining vakillaridan ish bilan ta’minlashga ko‘maklashuvchi muvofiqlashtirish qo‘mitalari tuziladi. Kasaba uyushmalari va ish beruvchilarning vakillari qo‘mitalarning tarkibiga teng miqdorda kiritiladi.
...
4. Chet ellarda fuqarolarni, shuningdek chet ellarda ishlash yuzasidan xususiy mehnat bitimlariga ega bo‘lgan O‘zbekiston Respublikasi fuqarolarini, O‘zbekistonga ishga kelgan chet el fuqarolarini ishga yollash va ishga joylashtirish bilan shug‘ullanadigan yuridik va jismoniy shaxslarning faoliyat ko‘rsatishiga, kadrlarni o‘qitish, qayta tayyorlash va malakasini oshirish hamda ishga joylashtirish bo‘yicha pulli xizmat ko‘rsatuvchi yuridik shaxslarning faoliyat ko‘rsatishiga O‘zbekiston Respublikasi Mehnat vazirligi beradigan litsenziyaga binoan ruxsat etiladi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>20-modda. Ish bilan ta’minlash davlat xizmatining vazifalari va huquqlari</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>1. Ish bilan ta’minlash davlat xizmati:
...
faoliyati aholini ish bilan ta’minlash bilan bog‘liq vositachi tashkilotlarni ro‘yxatga olish va ular faoliyati uchun litsenziyalar berish huquqlariga egadirlar.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>21-modda. Korxonalar, tashkilotlar, muassasalarning ish bilan ta’minlashga doir davlat siyosatini ro‘yobga chiqarishda ishtirok etishi</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>1. O‘z faoliyatini O‘zbekiston Respublikasi hududida amalga oshirayotgan korxonalar, muassasalar, tashkilotlar mulkchilik va xo‘jalik yuritishning shakllaridan qat’i nazar, ish bilan ta’minlashga doir davlat siyosatini:
...
Ijtimoiy muhofazaga muhtoj kishilar uchun tashkil etilgan ish joylari xalq deputatlari mahalliy Sovetlari, kasaba uyushmalari va ish bilan ta’minlash davlat xizmatining idoralari bilan kelishgan holdagina qisqartiriladi yoki tugatiladi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>22-modda. Aholini ish bilan ta’minlashda kasaba uyushmalarining ishtiroki</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Kasaba uyushmalari ish bilan ta’minlash davlat siyosatiga doir masalalar bo‘yicha O‘zbekiston Respublikasining tegishli qonun hujjatlarini va xalq deputatlari mahalliy Sovetlarining qarorlarini ishlab chiqish hamda amalga oshirishda ishtirok etadilar.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>23-modda. Ish bilan ta’minlashga ko‘maklashish respublika jamg‘armasi</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>1. Ish bilan ta’minlashga ko‘maklashish respublika jamg‘armasi respublika miqyosida va mahalliy darajada vujudga keltirilib, ish bilan ta’minlash siyosatini ro‘yobga chiqarish borasidagi chora-tadbirlarni pul bilan ta’minlashga va ish bilan ta’minlash idoralarining samarali faoliyat ko‘rsatishiga mo‘ljallanadi.
<br/>
...
3. Ish bilan ta’minlashga ko‘maklashish jamg‘armasi mablag‘larini nimalarga sarflash aholini ish bilan ta’minlash borasidagi tegishli respublika va mintaqa dasturlarida belgilab beriladi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>24-modda. Haq to‘lanadigan jamoat ishlarini tashkil etish</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Xalq deputatlari mahalliy Sovetlari ish bilan ta’minlash davlat xizmatlarining takliflariga muvofiq va ularning ishtirokida o‘z mulki bo‘lgan korxonalar, muassasalar, tashkilotlarda hamda shartnomalar asosida boshqa korxonalar, muassasalar, tashkilotlarda haq to‘lanadigan jamoat ishlarini amalga oshirilishini tashkil etadilar.
...
Aholining turli guruhlari uchun haq to‘lanadigan jamoat ishlarini tashkil etish tartibi va ularni o‘tkazish shartlari O‘zbekiston kasaba uyushmalari Federatsiyasi Kengashi bilan kelishilgan holda O‘zbekiston Respublikasi Vazirlar Mahkamasi tomonidan tasdiqlanadi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>25-modda. Ishsizlarga kasb o‘rgatish, ularning malakasini oshirish va ularni qayta tayyorlash</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>1. Davlat ish bilan ta’minlash xizmatida ro‘yxatdan o‘tgan va ishsizlik maqomini olgan shaxslarni kasbga o‘rgatish, ularning malkasini oshirish va qayta tayyorlash basharti:
...
2. Fuqarolarga kasb o‘rgatish, ularning malakasini oshirish va ularni qayta tayyorlash ish bilan ta’minlash davlat xizmatlarining yo‘llanmalari bo‘yicha o‘quv yurtlarida ish bilan ta’minlashga ko‘maklashish jamg‘armasida ana shu maqsadlar uchun ko‘zda tutilgan mablag‘lar hisobidan amalga oshiriladi.</p>
    ...
    },
    {
      ...
      content: (
        <>
          <h2 className="text-2xl sm:text-3xl font-bold text-sky-700 mb-6 pb-3 border-b border-gray-200">IV bo‘lim. Ishdan mahrum bo‘lgan chog‘dagi ijtimoiy kafolatlar</h2>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>26-modda. Moddiy madad kafolatlari</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>O‘zbekiston Respublikasi ishdan mahrum bo‘lgan, birinchi bor ish qidirayotgan, shuningdek uzoq tanaffusdan keyin mehnat faoliyatini qayta boshlashni istagan fuqarolarga:
...
2. Mehnat intizomini buzganligi uchun ishdan bo‘shatilgan, shuningdek uzoq vaqt ishlamayotgan, birinchi marta ish qidirayotgan va kasb o‘rganishga, malaka oshirishga va qayta tayyorgarlikdan o‘tishga muhtoj bo‘lgan shaxslarga aholining shu toifasi uchun nazarda tutilgan ishsizlik nafaqasidan kam bo‘lmagan va O‘zbekiston Respublikasida belgilangan eng kam ish haqidan ortiq bo‘lmagan miqdorda stipendiya tayinlanadi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>29-modda. Ishsizlik nafaqalarini to‘lash shartlari va muddatlari</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>1. Ishsizlik nafaqasi belgilangan tartibda ishsiz deb topilgan shaxslarga ular aholini ish bilan ta’minlash davlat xizmatida ro‘yxatdan o‘tgan kunlaridan boshlab tayinlanadi.
...
4. Xodimlar soni (shtatlar) qisqartirilishi, korxonalar, tashkilotlar va muassasalarning qayta tashkil etilishi yoki tugatilishi munosabati bilan ishdan bo‘shagan, ishsiz deb e’tirof etilgan, shuningdek pensiya ta’minoti to‘g‘risidagi qonunlarga muvofiq umumiy mehnat staji pensiyaga chiqish huquqiga ega bo‘lgan shaxslar muddatidan oldin (qonunlarda belgilangan muddatdan 2 yil oldin) pensiyaga chiqishga haqlidirlar.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>30-modda. Ishsizlik nafaqasi miqdorlarini aniqlash tartibi</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>1. Ishidan va ish haqidan (mehnat daromadidan) mahrum bo‘lgan shaxslar uchun ishsizlik nafaqasi avvalgi ish joyidagi oxirgi bir yilgi ish haqiga foiz nisbatida belgilanadi. Boshqa hamma hollarda ishsizlik nafaqasi eng kam miqdordagi ish haqiga foiz nisbatida belgilanadi.
<br />
...
4. Ishsizlik nafaqasining miqdori belgilangan tartibda indekslanishi lozim.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>31-modda. Ishidan va ish haqidan mahrum bo‘lgan shaxslar uchun ishsizlik nafaqasining miqdori</h3>
...
2. Fuqaro ishsizlik nafaqasi olib turgan davrda uning mehnat stajida uzilish bo‘lmaydi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>32-modda. Harbiy xizmatdan, ichki ishlar va milliy xavfsizlik idoralaridan bo‘shatilgan shaxslar uchun ishsizlik nafaqasining miqdori</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Harbiy xizmatdan, ichki ishlar va milliy xavfsizlik idoralaridan bo‘shatilishi natijasida ish haqini yo‘qotgan shaxslar ushbu Qonunning 31-moddasida ko‘zda tutilgan shartlar asosida nafaqa olish huquqiga egadirlar.
...
Harbiy xizmatdan, ichki ishlar va milliy xavfsizlik idoralaridan bo‘shatilgan hamda ish bilan ta’minlash davlat xizmatiga murojaat qilishdan oldin ishlamagan shaxslarga nafaqa miqdori respublika bo‘yicha belgilangan eng oz ish haqi darajasida belgilanadi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>33-modda. Birinchi marta ish qidirayotgan shaxslar uchun ishsizlik nafaqasining miqdori</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Ilgari ishlamagan, birinchi marta ish qidirayotgan va ishsizlik nafaqasini olish huquqiga ega bo‘lgan shaxslarga ish bilan ta’minlash davlat xizmatlari kasb o‘rganish yoki ishga joylashish uchun imkoniyat bermagan taqdirda ularga belgilangan eng oz ish haqining kamida 75 foizi miqdorida nafaqa olish uchun kafolat beriladi.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>34-modda. Uzoq muddatli tanaffusdan keyin ish qidirayotgan shaxslar uchun ishsizlik nafaqasining miqdori</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Uzoq muddatli tanaffusdan keyin yana mehnat faoliyatini boshlashga harakat qilayotgan ishsizlarga:
...
boshqa hollarda, shu jumladan ixtisosi bo‘lmagan kishilarga ish bilan ta’minlash davlat xizmati kasb o‘rganish imkoniyatini bermagan taqdirda belgilangan eng kam ish haqining 75 foizi miqdorida nafaqa to‘lanishiga kafolat beriladi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>35-modda. Kasb o‘rganish va qayta tayyorgarlik ko‘rishdan o‘tgan shaxslar uchun ishsizlik nafaqasining miqdori</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Ishsiz deb e’tirof etilgan shaxslar ishlab chiqarishdan ajralgan holda kasb o‘rgangan va qayta tayyorgarlikdan o‘tgandan keyin O‘zbekiston Respublikasi qonunlarida belgilangan eng kam ish haqidan kam bo‘lmagan miqdorda ishsizlik nafaqasi olish huquqiga egadirlar.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>36-modda. Ishsizlik nafaqasi to‘lashni to‘xtatib turish va butunlay to‘xtatib qo‘yish</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Quyidagi hollarda:
...
mehnat intizomini buzganlik uchun ishdan bo‘shatilgan bo‘lsa, ishsizlik nafaqasini to‘lash 3 oygacha muddatga to‘xtatib turiladi yoki uning miqdori kamaytiriladi.</p>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>36-1-modda. Homilador ayollarni ijtimoiy muhofaza qilish</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Ishsiz homilador ayollar (basharti homiladorlik davri 28 haftadan oshmagan bo‘lsa,) ish bilan ta’minlash davlat xizmati tomonidan umumiy asosda ish qidiruvchi shaxs sifatida ro‘yxatga olinadilar. Ish bilan ta’minlash davlat xizmati 10 kun ichida ularni ish bilan ta’minlay olmasa, u holda o‘n birinchi kundan boshlab ularga ishsizlik maqomi beriladi. Ishsizlik maqomi birligidan qat’i nazar, homilador ayollarga O‘zbekiston Respublikasida belgilangan eng kam oylik ish haqi miqdorida 12 oy mobaynida 26 kalendar haftadan oshmagan muddatga ishsizlik nafaqasi to‘lanadi.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>37-modda. Moddiy yordam</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Ishsizga va uning qaramog‘idagi oila a’zolariga moddiy va o‘zga yordam ko‘rsatilishi mumkin, ular ish bilan ta’minlashga ko‘maklashish jamg‘armasidan va tegishli mahalliy budjetdan ajratiladi.
...
Ish bilan ta’minlashga ko‘maklashish jamg‘armasidan va mahalliy budjetlardan moddiy va o‘zga yordam ko‘rsatish tartibi, hajmi va shartlari O‘zbekiston Respublikasi Mehnat vazirligi hamda xalq deputatlari mahalliy Kengashlarining qarorlari bilan belgilanadi.</p>
    ...
    },
    {
      ...
      content: (
        <>
          <h2 className="text-2xl sm:text-3xl font-bold text-sky-700 mb-6 pb-3 border-b border-gray-200">V bo‘lim. Aholini ish bilan ta’minlashga doir qonunlar bajarilishini nazorat qilish va ularni buzganlik uchun javobgarlik</h2>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>38-modda. Aholini ish bilan ta’minlash to‘g‘risidagi qonunlarning bajarilishini nazorat qiluvchi idoralar</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Aholini ish bilan ta’minlash to‘g‘risidagi qonunlarning bajarilishi ustidan nazoratini davlat hokimiyati va boshqaruvi mahalliy organlari, O‘zbekiston Respublikasi Mehnat vazirligi, prokuratura organlari va kasaba uyushmalari amalga oshiradi.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>39-modda. Ish bilan ta’minlash haqidagi qonunlarni buzganlik uchun javobgarlik</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>“Aholini ish bilan ta’minlash to‘g‘risida”gi O‘zbekiston Respublikasi Qonunini buzganlik uchun intizomiy va ma’muriy javobgarlik belgilab qo‘yiladi.</p>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-semibold text-red-600 py-4 px-3 sm:px-5 bg-red-50 rounded-lg my-4'>40-modda. Mehnatga ma’muriy tarzda majburlaganlik uchun javobgarlik</h3>
            <p className='text-gray-700 leading-relaxed text-sm sm:text-base mb-6 px-3 sm:px-5'>Ushbu Qonun 2-moddasi 1-bandining uchinchi qismida nazarda tutilgan harakatlarning sodir etilishida aybdor bo‘lgan shaxslar qonun hujjatlariga muvofiq ma’muriy javobgarlikka tortiladilar.</p>
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="w-full max-w-7xl mx-auto px-2 sm:px-4 md:px-8 pt-24 pb-4 md:pt-28 md:pb-8 flex-1 flex flex-col">
        <div className="text-center mb-6">
          ...
          <p className="text-sm sm:text-base md:text-lg">AHOLINI ISH BILAN TA’MINLASH TO‘G‘RISIDA</p>
          <p className="text-left mt-5">Ushbu Qonun bozor iqtisodiyoti va mulkchilikning turli shakllari teng huquqliligi sharoitida insonning ishli bo‘lish huquqlarini ro‘yobga chiqarishning tashkiliy, huquqiy va ijtimoiy-iqtisodiy kafolatlarini belgilab beradi. Qonun O‘zbekiston Respublikasi Konstitutsiyasi qoidalarini va xalqaro qoidalarni hisobga olgan holda aholini ish bilan ta’minlash uchun shart-sharoitlar yaratishga qaratilgandir.</p>
        </div>
