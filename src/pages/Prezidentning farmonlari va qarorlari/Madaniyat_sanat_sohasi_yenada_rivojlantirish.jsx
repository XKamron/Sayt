...
Amalga oshirilayotgan chora-tadbirlar natijadorligi yuzasidan O‘zbekiston Respublikasi Prezidentiga har chorakda axborot berilsin.
          ...
          <div className="flex justify-between items-center mt-8 md:mt-12 font-medium">
            <div className="text-center">
              <p>Toshkent sh.,</p>
              <p>2022-yil 2-fevral,</p>
              <p>PQ-112-son</p>
            </div>
            <div className="text-right">
              <p>O'zbekiston Respublikasining Prezidenti</p>
              <p>Sh. MIRZIYOYEV</p>
              <p className="mt-4">O'zbekiston Respublikasi Prezidentining</p>
              <p>2022-yil 2-fevraldagi PQ-112-son</p>
              <p>qaroriga 1-ILOVA</p>
            </div>
          </div>
        </div>
        
        <div className="mt-8 md:mt-12">
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-sky-600 text-center mb-6">
            Xalq ta'limi vazirligi tasarrufidagi umumiy o'rta ta'lim muassasalari
            ta'minlanishi lozim bo'lgan milliy musiqa cholg'ulari RO'YXATI
          </h2>
          ...
          <div className="prose prose-sm sm:prose-base max-w-none text-gray-800 leading-relaxed space-y-4">
            ...
            <div className="mt-6">
              ...
              <p>
                Madaniyat vazirligi va Xalq ta'limi vazirligining takliflari asosida ushbu ro'yxatga 
                Vazirlar Mahkamasining qarori bilan o'zgartirish va qo'shimchalar kiritilishi mumkin.
              </p>
              <p className="mt-2">
                O'quvchilarning qiziqishlaridan kelib chiqib, ushbu ro'yxatda keltirilmagan boshqa 
                musiqa cholg'ularida kuy ijro etish ko'nikmalari o'rgatilishi ham tashkil etilishi mumkin.
              </p>
              <p className="mt-2">
                O'quvchining qo'shimcha o'rgangan, shu jumladan ushbu ro'yxatda keltirilmagan 
                musiqa cholg'ularida kuy ijro etish ko'nikmasiga egaligi haqida ham uning ta'lim 
                to'g'risidagi hujjatiga tegishli qo'shimcha qayd kiritiladi.
              </p>
            </div>
          </div>
        </div>
