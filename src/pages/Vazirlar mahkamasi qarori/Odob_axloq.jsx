    ...
    <div className="flex flex-col min-h-screen bg-white font-['Montserrat', 'sans-serif']">
      ...
      <main className="w-full max-w-7xl mx-auto px-2 sm:px-4 md:px-8 py-4 md:py-8 flex-1 flex flex-col font-['Montserrat', 'sans-serif']">
        <div className="text-center mb-6">
          ...
          <h2 className="text-sm sm:text-base md:text-lg font-['Montserrat', 'sans-serif']">Davlat fuqarolik xizmatchilari tomonidan odob-axloq qoidalariga rioya etilishini ta'minlash bo'yicha qo'shimcha chora-tadbirlar to'g'risida</h2>
          <p className="text-left mt-5 font-['Montserrat', 'sans-serif']">“Davlat fuqarolik xizmati to‘g‘risida”gi O‘zbekiston Respublikasi Qonuniga muvofiq hamda davlat xizmatchilarining xizmat faoliyatiga oid va xizmatdan tashqari odob-axloqi, jamoatchilik bilan munosabatlariga doir qoidalarga rioya etilishini ta’minlash maqsadida Vazirlar Mahkamasi qaror qiladi:
<br/>
1. Quyidagilar:
<br/>
...
Davlat xizmatchilari tomonidan Odob-axloq qoidalariga rioya qilinishi holati ularni kelgusida yuqori lavozimlarga tayinlash va rahbar kadrlar zaxirasini shakllantirishda hisobga olinadi.
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-left mt-5">7. Davlat xizmatchilari:
...
8. Davlat xizmatchilari o‘ziga bo‘ysunuvchi xodimlardan ular mehnat vazifasini bajarayotgan paytda partiya nomidan siyosiy faoliyat bilan shug‘ullanishni talab qilishi, siyosiy partiyalar, jamoat birlashmalari va boshqa nodavlat tashkilotlari faoliyatida ishtirok etishga da’vat etishi yoki majburlashiga yo‘l qo‘yilmaydi.
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-left mt-5">9. Davlat xizmatchilari xizmat faoliyati davomida quyidagilarga majbur:
...
<p className="text-left mt-5">12. Davlat xizmatchilari ishdan bo‘sh vaqtlarida umumqabul qilingan axloq normalariga rioya qilishlari va ularga zid bo‘lgan xulq-atvor va xatti-harakatlardan o‘zlarini tiyishlari shart.
<br/>
...
<p className="text-left mt-5">14. Davlat xizmatchilari ommaviy axborot vositalari bilan o‘zaro hamkorlik qilishi, davlat organlari va tashkilotlarining faoliyatini ommaviy axborot vositalarida yoritilishiga ko‘maklashishi kerak.
<br/>
...
<p className="text-left mt-5">19. Davlat xizmatchilarining xizmat faoliyatidagi tashqi ko‘rinishi va kiyinish uslubi fuqarolarning davlat organlari va tashkilotlari faoliyatiga hurmatini, shu jumladan davlat xizmatining nufuzini oshirishga xizmat qilishi kerak.
<br/>
...
<p className="text-left mt-5">22. Davlat xizmatchilari mansab yoki xizmat majburiyatlarini bajarish vaqtida manfaatlar to‘qnashuviga olib keladigan yoki olib kelishi mumkin bo‘lgan shaxsiy manfaatdorlikka yo‘l qo‘ymasligi kerak.
<br/>
...
<p className="text-sm sm:text-base md:text-lg">8-bob. Davlat xizmatchilarining manfaatini himoya qilish</p>
<p className="text-left mt-5">24. Davlat xizmatchilarni xizmat vazifalarini bajarish bilan bog‘liq tahdid, haqorat, tuhmat va qonunga xilof boshqa xatti-harakatlardan himoya qilish davlat organlari va tashkilotlarining rahbari tomonidan amalga oshiriladi.
<br/>
...
<p className="text-left mt-5">26. Davlat xizmatchilari tomonidan odob-axloq qoidalariga rioya etilishi ustidan nazorat davlat organlari va tashkilotlarining inson resurslarini boshqarish bo‘linmalari yoki Odob-axloq komissiyalari, shuningdek maxsus vakolatli davlat organi tomonidan amalga oshiriladi.
<br/>
...
<p className="text-left mt-5">29. Davlat xizmatchilari tomonidan Odob-axloq qoidalariga rioya etmaganlik holati ularga nisbatan axloqiy va intizomiy ta’sir choralarini qo‘llash uchun asos bo‘ladi.
<br/>
...
<p className="text-sm sm:text-base md:text-lg">11-bob. Yakuniy qoida</p>
<p className="text-left mt-5">33. Davlat organlari va tashkilotlari faoliyatining o‘ziga xos xususiyatlaridan kelib chiqqan holda mazkur Odob-axloq qoidalariga muvofiq o‘z idoraviy odob-axloq qoidalarini tasdiqlaydi.
</p>
<div>
  <p className='text-right font-bold'>Vazirlar Mahkamasining 2022-yil 14-oktabrdagi 595-son qaroriga
  2-ILOVA</p>
</div>
</div>
<div className="text-center mb-6">

<p className="text-sm sm:text-base md:text-lg">Odob-axloq komissiyasi to‘g‘risidagi
NAMUNAVIY NIZOM</p>
<p className="text-sm sm:text-base md:text-lg">1-bob. Umumiy qoidalar</p>
<p className="text-left mt-5">1. Ushbu Namunaviy nizom davlat organlari va tashkilotlarida Odob-axloq komissiyalari (keyingi o‘rinlarda — Komissiya) faoliyatini tartibga soladi.
<br/>
...
<p className="text-sm sm:text-base md:text-lg">4-bob. Davlat xizmatchilari tomonidan odob-axloq qoidalari buzilishining oldini olish (profilaktika) choralarini ko‘rish</p>
<p className="text-left mt-5">19. Komissiya davlat organlari va tashkilotlarining inson resurslarini boshqarish bo‘linmalari bilan birgalikda muntazam ravishda davlat xizmatchilari tomonidan odob-axloq qoidalariga rioya etilishi va ularning buzilishini oldini olishga qaratilgan quyidagilarni nazarda tutuvchi profilaktik kompleks chora-tadbirlarni amalga oshiradi:
...
<p className="text-sm sm:text-base md:text-lg">5-bob. Davlat xizmatchilari tomonidan odob-axloq qoidalarining buzilishi bilan bog‘liq masalalarni ko‘rib chiqish tartibi</p>
<p className="text-left mt-5">23. Komissiya davlat xizmatchilari tomonidan odob-axloq qoidalarining buzilishlari bilan bog‘liq masalalarni:
...
<div>
  <p className='text-right font-bold pt-5'>
  Odob-axloq komissiyasi to‘g‘risidagi namunaviy nizomga
  ILOVA
  </p>
</div>
</div>
...
<p className="text-sm sm:text-base md:text-lg font-bold">Odob-axloq komissiyasi faoliyatini tashkil qilish va davlat xizmatchilari tomonidan odob-axloq qoidalarining buzilishi bilan bog'liq masalalarni ko'rib chiqish
SXEMASI</p>
    
</div>

{/* Odob-axloq komissiyasi sxemasi jadvali */}
<div className="overflow-x-auto mb-8">
  <table className="w-full border-collapse border border-gray-400 text-sm">
    <thead>
      <tr className="bg-gray-100">
        <th className="border border-gray-400 px-3 py-2 text-left font-bold">Bosqichlar</th>
        <th className="border border-gray-400 px-3 py-2 text-left font-bold">Subyektlar</th>
        <th className="border border-gray-400 px-3 py-2 text-left font-bold">Tadbirlar</th>
        <th className="border border-gray-400 px-3 py-2 text-left font-bold">Ijro muddati</th>
      </tr>
    </thead>
    <tbody>
      {/* I. Komissiya faoliyatini tashkil etish */}
      <tr>
        <td className="border border-gray-400 px-3 py-2 font-bold bg-gray-50" colSpan="4">
          I. Komissiya faoliyatini tashkil etish
        </td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top">1-bosqich</td>
        <td className="border border-gray-400 px-3 py-2 align-top">Davlat organi va tashkiloti rahbari</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          1. Davlat organlari va tashkilotlarida Odob-axloq komissiyalarini (keyingi o'rinlarda — Komissiya) Komissiya raisi, kotibi va a'zolaridan iborat tarkibda, umumiy soni kamida besh nafardan kam bo'lmagan miqdorda toq sonda shakllantirish.<br/><br/>
          2. Komissiya tarkibiga tajribali, mehnat jamoasida obro'-e'tiborga sazovor bo'lgan davlat xizmatchilarini kiritish.<br/><br/>
          3. Komissiya tarkibini tasdiqlash.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">Ikki hafta muddatda</td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top"></td>
        <td className="border border-gray-400 px-3 py-2 align-top"></td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          4. Komissiya tarkibiga komissiya tomonidan qabul qilinadigan qarorlarga ta'sir ko'rsatishi mumkin bo'lgan manfaatlar to'qnashuvi ehtimolini nazarda tutgan holda o'zgartirish kiritiladi.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">Zaruratga ko'ra</td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top">2-bosqich</td>
        <td className="border border-gray-400 px-3 py-2 align-top">Komissiya raisi</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Komissiya ishini tashkil etadi, komissiya majlislarini chaqiradi va o'tkazadi majlisiga raislik qiladi.<br/><br/>
          Komissiya nomidan ish yuritadi, Komissiya majlislarida Komissiya faoliyati to'g'risidagi axborot bilan so'zga chiqadi.<br/><br/>
          Davlat organi va tashkiloti rahbariga Komissiya faoliyati to'g'risida hisobot taqdim etadi.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Ma'lumotlar kiritilgan vaqtdan boshlab<br/><br/>
          Har yili yil yakuni bo'yicha
        </td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top"></td>
        <td className="border border-gray-400 px-3 py-2 align-top">Komissiyaning kotibi</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Kun tartibiga muvofiq Komissiya majlislari o'tkazilishini tashkil etadi. Komissiyaning a'zolarini va taklif etilgan shaxslarni Komissiya majlisi o'tkaziladigan joy, sana va vaqt hamda kun tartibiga kiritilgan masalalar haqida xabardor qiladi. Komissiyaning faoliyatini tashkiliy-texnik jihatdan ta'minlash masalalarini hal qiladi, navbatdagi majlisiga barcha zarur materiallar o'z vaqtida tayyorlanishini ta'minlaydi. Komissiya majlisining bayonnomasini rasmiylashtiradi va tasdiqlangan bayonnomaning manfaatdor shaxslarga jo'natilishini ta'minlaydi.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Majlisdan kamida ikki kun oldin<br/><br/>
          Majlisdan keyin bir kun muddatda
        </td>
      </tr>
      
      {/* II. Odob-axloq qoidalari buzilishining oldini olish */}
      <tr>
        <td className="border border-gray-400 px-3 py-2 font-bold bg-gray-50" colSpan="4">
          II. Odob-axloq qoidalari buzilishining oldini olish (profilaktika) choralarini ko'rish
        </td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top">1-bosqich</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Komissiya<br/>
          Davlat organining tarkibiy bo'linmalari<br/>
          kasaba uyushmalari qo'mitalari
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Komissiya muntazam ravishda davlat xizmatchilari tomonidan odob-axloq qoidalariga rioya etilishi va ularning buzilishining oldini olishga qaratilgan quyidagilarni nazarda tutuvchi profilaktik kompleks chora-tadbirlarni amalga oshiradi:<br/><br/>
          • davlat xizmatchilarida yuksak kasbiy madaniyatni, jamoada sog'lom ma'naviy muhit va ishchan kayfiyatni shakllantirish;<br/><br/>
          • davlat xizmatchilari "halollik vaksinasi" bilan emlash, ya'ni halollikni ularning ongiga singdirish, ma'rifat orqali ularda korrupsiyaga qarshi murosasiz munosabatda bo'lish kayfiyatini shakllantirish;<br/><br/>
          • davlat organi va tashkilotida taniqli ziyolilar, ijodkorlar, ma'naviyat va ma'rifat sohasi, shuningdek diniy sohaning ko'zga ko'ringan namoyondalari, o'z sohasida yuksak natijalarga erishgan mehnat faxriylarini jalb qilgan holda, uchrashuvlar tashkil qilib borish;<br/><br/>
          • davlat organi va tashkilotida xodimlarining kasbiy va boshqaruv ko'nikmalari o'sishini, shuningdek ularning malakasini doimiy ravishda oshirishni, ular tomonidan odob-axloq qoidalariga rioya etishlarini ta'minlash maqsadida ularning bilimlari va malakasini doimiy oshirish ishlarini ta'minlash;<br/><br/>
          • davlat xizmatchilarining iqtisodiy bilimlarini, huquqiy savodxonligini, huquqiy madaniyati va huquqiy ongini, intellektual va ma'naviy rivojlanishini ta'minlash maqsadida iqtisodiy va huquqiy o'qishlar tashkil etish;<br/><br/>
          • yangi ishga qabul qilingan davlat xizmatchilarini odob-axloq qoidalariga qat'iy rioya qilish borasida stajirovkadan o'tkazish va ular bilan profilaktik suhbatlar tashkil qilish;<br/><br/>
          • davlat xizmatchilarini malaka oshirish kurslariga, xalqaro seminarlar, konferensiyalar va shu kabi boshqa tadbirlarga yuborish, ular tomonidan o'z kasbiy darajasi va axloqiy sifatlarini mustaqil oshirishlari uchun shart-sharoit yaratib berish.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Komissiya tomonidan tasdiqlanadigan choraklik ish rejalari asosida
        </td>
      </tr>
      
      {/* III. Odob-axloq qoidalarining buzilishi bilan bog'liq masalalarni ko'rib chiqish */}
      <tr>
        <td className="border border-gray-400 px-3 py-2 font-bold bg-gray-50" colSpan="4">
          III. Odob-axloq qoidalarining buzilishi bilan bog'liq masalalarni ko'rib chiqish
        </td>
      ...
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top">1-bosqich</td>
        <td className="border border-gray-400 px-3 py-2 align-top">Komissiya</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Komissiya davlat xizmatchilarining odob-axloq qoidalarini buzilishlari bilan bog'liq masalalarni:<br/><br/>
          • davlat organi va tashkiloti rahbarining topshirig'iga ko'ra;<br/>
          • huquqni muhofaza qiluvchi organlarning murojaatiga asosan;<br/>
          • davlat xizmatchilarning, shuningdek jismoniy va yuridik shaxslarning murojaatlariga binoan;<br/>
          • o'z tashabbusi bilan ko'rib chiqadi.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">Zaruratga ko'ra</td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top">2-bosqich</td>
        <td className="border border-gray-400 px-3 py-2 align-top">Komissiya raisi va a'zolari</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Komissiya majlisida:<br/>
          • kun tartibidagi masala o'qib eshittiriladi;<br/>
          • davlat organi va tashkiloti rahbarining topshirig'i yoki davlat xizmatchisi tomonidan odob-axloq qoidalari buzilganligi to'g'risidagi murojaat o'qib eshittiriladi;<br/>
          • odob-axloq qoidalariga rioya etmaganlikda ayblanayotgan davlat xizmatchisi va murojaatchilar tushuntirishlari eshitiladi.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">Majlis o'tkaziladigan kun</td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top"></td>
        <td className="border border-gray-400 px-3 py-2 align-top">Davlat xizmatchisi</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          O'zining huquqi, sha'ni va qadr-qimmatiga, ishchanlik obro'siga daxl qiladigan murojaat bo'yicha amaldagi qonun hujjatlariga muvofiq o'zini himoya qilishga, Komissiyaga zarur materiallar hamda boshqa axborotlarni taqdim etishga haqli.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top"></td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top">3-bosqich</td>
        <td className="border border-gray-400 px-3 py-2 align-top">Komissiya</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          1. Majlis yakuni bo'yicha davlat xizmatchisining harakatlarida odob-axloq qoidalarining buzilishi faktining mavjudligini yoxud mavjud emasligi to'g'risida qaror qabul qiladi.<br/><br/>
          2. Odob-axloq qoidalari buzilganligi fakti aniqlangan taqdirda davlat xizmatchilariga quyidagi axloqiy ta'sir choralari qo'llaydi:<br/>
          • ogohlantirish;<br/>
          • uzr so'rash yoki rasmiy uzrnoma keltirishni talab qilish;<br/>
          • davlat organi va tashkilotining kengaytirilgan majlisida tanbeh berish.<br/><br/>
          3. Davlat xizmatchisiga nisbatan intizomiy ta'sir chorasini qo'llash uchun davlat organi va tashkiloti rahbariga taqdimnoma kiritishi mumkin.<br/><br/>
          4. Qabul qilingan qaror haqida murojaat qiluvchiga, o'ziga nisbatan masala ko'rib chiqilgan davlat xizmatchisiga va davlat organi va tashkiloti rahbariga yozma ravishda ma'lum qiladi.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">Majlis o'tkaziladigan kun</td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top">4-bosqich</td>
        <td className="border border-gray-400 px-3 py-2 align-top">Komissiya</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Odob-axloq qoidalari davlat organi va tashkiloti rahbari tomonidan buzilgan taqdirda ularga nisbatan tegishli chora ko'rish masalasi yuzasidan takliflarni yuqori turuvchi davlat organi va tashkiloti rahbariga yuboradi.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">Zaruratga ko'ra</td>
      </tr>
      <tr>
        <td className="border border-gray-400 px-3 py-2 align-top">5-bosqich</td>
        <td className="border border-gray-400 px-3 py-2 align-top">Davlat xizmatchisi</td>
        <td className="border border-gray-400 px-3 py-2 align-top">
          Komissiyaning qarori ustidan davlat organi va tashkiloti rahbariga yoki sudga shikoyat qilish mumkin.
        </td>
        <td className="border border-gray-400 px-3 py-2 align-top">Zaruratga ko'ra</td>
      </tr>
    </tbody>
...
<div>
  <p className='text-right font-bold pb-5'>
  Vazirlar Mahkamasining 2022-yil 14-oktabrdagi 595-son qaroriga
  3-ILOVA
  </p>
</div>
<div className="text-center mb-6">
...
RO‘YXATI</p>
<p className="text-left mt-5">1. Vazirlar Mahkamasining “Davlat boshqaruvi organlari va mahalliy ijro etuvchi hokimiyat organlari xodimlarining odob-axloq namunaviy qoidalarini tasdiqlash to‘g‘risida” 2016-yil 2-martdagi 62-son qarori.
<br/>
2. Vazirlar Mahkamasining “O‘zbekiston Respublikasi Hukumatining ayrim qarorlariga o‘zgartirishlar kiritish to‘g‘risida” 2022-yil 4-apreldagi 153-son qaroriga ilovaning 376-bandi.
</p>
</div>
      </main>
      <Footer />
