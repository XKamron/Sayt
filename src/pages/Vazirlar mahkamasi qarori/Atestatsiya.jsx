    ...
    <div className="flex flex-col min-h-screen bg-white font-['Montserrat', 'sans-serif']">
      ...
      <main className="w-full max-w-7xl mx-auto px-2 sm:px-4 md:px-8 py-4 md:py-8 flex-1 flex flex-col font-['Montserrat', 'sans-serif']">
        <div className="text-center mb-6">
          ...
          <h2 className="text-sm sm:text-base md:text-lg font-['Montserrat', 'sans-serif']">Davlat ta'lim muassasalari hamda nodavlat ta'lim tashkilotlarini attestatsiyadan va davlat akkreditatsiyasidan o'tkazish tartibini takomillashtirish to'g'risida</h2>
          <p className="text-left mt-5 font-['Montserrat', 'sans-serif']">O‘zbekiston Respublikasi Prezidentining “Nodavlat ta’lim xizmatlari ko‘rsatish faoliyatini yanada rivojlantirish chora-tadbirlari to‘g‘risida” 2017-yil 15-sentabrdagi PQ-3276-son va “Ta’lim sifatini nazorat qilish tizimini takomillashtirish bo‘yicha qo‘shimcha chora-tadbirlar to‘g‘risida” 2019-yil 16-yanvardagi PQ-4119-son qarorlariga muvofiq Vazirlar Mahkamasi qaror qiladi:
<br/>
...
<div className=''>
    ...
    <p>Vazirlar Mahkamasining 2019-yil 7-iyundagi 470 -son qaroriga
    1-ILOVA</p>
</div>              
            </div>
        </div>
        <div className="text-center mb-6">
          <p className="text-lg sm:text-xl md:text-2xl font-bold text-sky-600">Davlat ta’lim muassasalari hamda nodavlat ta’lim tashkilotlarini attestatsiyadan va davlat akkreditatsiyasidan o‘tkazish tartibi to‘g‘risida
          NIZOM</p>
          <p className="text-sm sm:text-base md:text-lg">1-bob. Umumiy qoidalar</p>
          <p className="text-left mt-5">1. Ushbu Nizom “Ta’lim to‘g‘risida”gi O‘zbekiston Respublikasi Qonuniga muvofiq idoraviy mansubligi va tashkiliy-huquqiy shakllaridan qat’i nazar O‘zbekiston Respublikasining maktabgacha, umumiy o‘rta, o‘rta maxsus, kasb-hunar, maktabdan tashqari, oliy, oliy ta’limdan keyingi ta’limni amalga oshiruvchi ilmiy va ta’lim tashkilotlari, kadrlar malakasini oshirish va ularni qayta tayyorlash davlat ta’lim muassasalarini hamda nodavlat ta’lim tashkilotlarini (keyingi o‘rinlarda — ta’lim tashkilotlari) attestatsiyadan va davlat akkreditatsiyasidan (keyingi o‘rinlarda — akkreditatsiya) o‘tkazish tartibini belgilaydi.
<br/>
...
Attestatsiya ta’lim tashkilotining faoliyatini baholashda davlat nazoratining asosiy shakli hisoblanadi va ta’lim tashkilotlarida kadrlar tayyorlash mazmuni, darajasi va sifatining davlat ta’lim standartlari hamda davlat ta’lim talablariga hamda o‘quv dasturlariga muvofiqligini aniqlashdan iborat.
<br/>
4. Attestatsiyaning asosiy prinsiplari quyidagilar hisoblanadi:
<br/>
...
9. Davlat inspeksiyasi O‘zbekiston Respublikasi Maktabgacha ta’lim vazirligi, Xalq ta’limi vazirligi, Oliy va o‘rta maxsus ta’lim vazirligi, Innovatsion rivojlanish vazirligi hamda tizimida davlat ta’lim muassasalari bo‘lgan boshqa vazirliklar va idoralar bilan kelishgan holda ushbu Nizom talablaridan kelib chiqib ta’lim tashkilotlarini attestatsiyadan o‘tkazish mezonlarini ishlab chiqadi hamda attestatsiya ular asosida o‘tkaziladi.
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm sm:text-base md:text-lg">2-bob. Ta’lim tashkilotlarini attestatsiyadan o‘tkazish</p>
          <p className="text-left mt-5">10. Attestatsiya Davlat inspeksiyasi tomonidan tashkil etiladi.
...
<p className="text-sm sm:text-base md:text-lg">4-bob. Attestatsiya yakunlari</p>
<p className="text-left mt-5">32. Attestatsiya natijalari asosida ekspert komissiyalari tomonidan ta’lim tashkilotida kadrlar tayyorlash mazmuni, darajasi va sifatining davlat ta’lim standartlari, davlat ta’lim talablari hamda o‘quv dasturlariga muvofiqligi haqida xulosa tayyorlanadi.
<br/>
